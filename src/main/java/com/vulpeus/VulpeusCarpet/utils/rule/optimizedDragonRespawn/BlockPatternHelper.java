package com.vulpeus.VulpeusCarpet.utils.rule.optimizedDragonRespawn;

import com.google.common.cache.LoadingCache;
import com.vulpeus.VulpeusCarpet.mixins.optimizedDragonRespawn.IMixinBlockPatternTestTransform;
...
public class BlockPatternHelper {
  public static BlockPattern.Result partialSearchAround(
      BlockPattern pattern, WorldView world, BlockPos pos) {
      ...
      for (Direction direction : Direction.values()) {
        for (Direction direction2 : Direction.values()) {
          ...
          if (direction2 == direction
              ...
              || (result =
                      ((IMixinBlockPatternTestTransform) pattern)
                          .invokeTestTransform(blockPos, direction, direction2, loadingCache))
                  == null) {
            continue;
          }
          return result;
